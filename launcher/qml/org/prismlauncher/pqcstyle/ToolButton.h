...
class PStyleToolButton : public PQuickStyleItem {
    Q_OBJECT
    QML_ELEMENT

   public:
    PStyleToolButton(QQuickItem* parent = nullptr);
    ~PStyleToolButton() = default;
   ...
   protected:
    const char* classNameForItem() const override { return "QToolToolButton"; }
