...
class PStyleMenuItem : public PQuickStyleItem {
    Q_OBJECT
    QML_ELEMENT

   public:
    PStyleMenuItem(QQuickItem* parent = nullptr);
    ~PStyleMenuItem() = default;
   ...
   protected:
    const char* classNameForItem() const override { return "QMenu"; }
