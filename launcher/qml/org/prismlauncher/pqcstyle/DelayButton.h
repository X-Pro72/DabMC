...
class PStyleDelayButton : public PQuickStyleItem {
    Q_OBJECT
    QML_ELEMENT

   public:
    PStyleDelayButton(QQuickItem* parent = nullptr);
    ~PStyleDelayButton() = default;
   ...
   protected:
    const char* classNameForItem() const override { return "QToolButton"; }
