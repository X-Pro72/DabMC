...
class PStyleGroupBox : public PQuickStyleItem {
    Q_OBJECT
    QML_ELEMENT

   public:
    PStyleGroupBox(QQuickItem* parent = nullptr);
    ~PStyleGroupBox() = default;
   ...
   protected:
    const char* classNameForItem() const override { return "QGroupBox"; }
};
