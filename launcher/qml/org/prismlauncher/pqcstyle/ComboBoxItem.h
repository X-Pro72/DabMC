...
class PStyleComboBoxItem : public PQuickStyleItem {
    Q_OBJECT
    QML_ELEMENT

   public:
    PStyleComboBoxItem(QQuickItem* parent = nullptr);
    ~PStyleComboBoxItem() = default;
   ...
   protected:
    const char* classNameForItem() const override { return "QComboMenuItem"; }
