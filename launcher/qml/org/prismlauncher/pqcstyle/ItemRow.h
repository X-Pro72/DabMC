...
class PStyleItemRow : public PQuickStyleItem {
    Q_OBJECT
    QML_ELEMENT

   public:
    PStyleItemRow(QQuickItem* parent = nullptr);
    ~PStyleItemRow() = default;
   ...
   protected:
    const char* classNameForItem() const override { return "QAbstractItemView"; }
