...
class PStyleMenuBarItem : public PQuickStyleItem {
    Q_OBJECT
    QML_ELEMENT

   public:
    PStyleMenuBarItem(QQuickItem* parent = nullptr);
    ~PStyleMenuBarItem() = default;
   ...
   protected:
    const char* classNameForItem() const override { return "QMenuBar"; }
