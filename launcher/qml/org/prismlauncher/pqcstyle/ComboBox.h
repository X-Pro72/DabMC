...
class PStyleComboBox : public PQuickStyleItem {
    Q_OBJECT
    QML_ELEMENT

   public:
    PStyleComboBox(QQuickItem* parent = nullptr);
    ~PStyleComboBox() = default;
   ...
   protected:
    const char* classNameForItem() const override { return "QComboBox"; }
