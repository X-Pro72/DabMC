...
class ResourcePage : public QWidget, public BasePage {
   ...
   public:
    ...
    virtual inline QString resourcesString() const { return m_desc.resourcesString; }
    //: The singular version of 'resources'
    virtual inline QString resourceString() const { return m_desc.resourceString; }
   ...
   protected:
    ResourcePage(ResourceDownloadDialog* parent, BaseInstance& i, ResourceDescriptor d = {}, ResourceProviderData p = {});
